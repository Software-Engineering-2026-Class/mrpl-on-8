...
1. Place the Knowledge Graph (in .ttl or .rdf format) inside the data/ folder, or use the existing dummy data in data/ or kg_g3/. Example: data/dummy_kg.ttl
...
2. Run the automated pipeline:
    ...
    ```
3. Parse the knowledge graph ontology
4. Generate CrewAI framework code
5. Generate AutoGen framework code
6. Check the output/ folder for generated scripts:
